<template>
  ...
  <script setup>
  import { ref } from 'vue';
  import { MousePointerClick , HeartIcon, MoonIcon, SunIcon, MaximizeIcon, MinimizeIcon } from 'lucide-vue-next';
  ...
  const startGifting = () => {
    // Implement the action to start the gifting process
    console.log('Start gifting process');
  };
  </script>
